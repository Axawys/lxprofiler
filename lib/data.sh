...
# «Таинственные» классы — те, что срабатывают на 100%. Их показываем особо:
# процент как «???%», полоску «сломанной», и всегда в самом низу списка.
declare -A MYSTERY=(
  [vm]=1
  [wsl]=1
  [dualboot]=1
...
declare -A DESC_HIGH=(
  ...
  [legacy]="Ты живёшь в прошлом и тебе там хорошо: старое ядро, X11 и древний WM — проверено годами."
